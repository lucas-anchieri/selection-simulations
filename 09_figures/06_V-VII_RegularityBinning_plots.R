...
ggsave(point_estimates,
       file = paste0(cwd, "../plots/panels/Figure_06/06-V-VII_a_point_estimates.png"),
...
ggsave(rmse, file = paste0(cwd, "../plots/panels/Figure_06/06-V-VII_c_rmse.pdf"),
...
ggsave(bias, file = paste0(cwd, "../plots/panels/Figure_06/06-V-VII_d_bias.pdf"),
       width = 2.5, height = 2.5, scale = 1.5)
...
ggsave(variance, file = paste0(cwd, "../plots/panels/Figure_06/06-V-VII_e_variance.pdf"),
       width = 2.5, height = 2.5, scale = 1.5)
...
ggsave(tpr, file = paste0(cwd, "../plots/panels/Figure_06/06-V-VII_b_tpr.pdf"),
       width = 2.5, height = 2.5, scale = 1.5)
...
ggsave(fig_V.VII_1, file = paste0(cwd, "../plots/Figure_06_regularity.pdf"),
